...
pub const devices = struct {
    ...
    pub const STM32L0x1 = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const LPUART1: *volatile types.peripherals.LPUART1 = @ptrFromInt(0x40004800);
            /// Universal synchronous asynchronous receiver transmitter
            pub const USART4: *volatile types.peripherals.USART1 = @ptrFromInt(0x40004c00);
            /// Universal synchronous asynchronous receiver transmitter
            pub const USART5: *volatile types.peripherals.USART1 = @ptrFromInt(0x40005000);
            ...
            pub const SYSCFG_COMP: *volatile types.peripherals.SYSCFG_COMP = @ptrFromInt(0x40010000);
            /// External interrupt/event controller
            pub const EXTI: *volatile types.peripherals.EXTI = @ptrFromInt(0x40010400);
            /// General-purpose-timers
            pub const TIM21: *volatile types.peripherals.TIM21 = @ptrFromInt(0x40010800);
            /// General-purpose-timers
            pub const TIM22: *volatile types.peripherals.TIM22 = @ptrFromInt(0x40011400);
            /// Firewall
            pub const Firewall: *volatile types.peripherals.Firewall = @ptrFromInt(0x40011c00);
            ...
            /// General-purpose I/Os
            pub const GPIOE: *volatile types.peripherals.GPIOB = @ptrFromInt(0x50001000);
            /// General-purpose I/Os
            pub const GPIOH: *volatile types.peripherals.GPIOB = @ptrFromInt(0x50001c00);
            /// SysTick timer
    ...
    pub const peripherals = struct {
        ...
        pub const Flash = extern struct {
            ...
            PECR: mmio.Mmio(packed struct(u32) {
                ...
                OBL_LAUNCH: u1,
                reserved23: u4,
                /// Non-Zero check notification disable
                NZDISABLE: u1,
                padding: u8,
            }),
            ...
            WRPROT1: mmio.Mmio(packed struct(u32) {
                /// Write protection
                WRPROT1: u32,
            }),
            reserved128: [92]u8,
